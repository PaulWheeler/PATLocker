...
<div id="right_pannel"; style="height:100%;">
	<div id="toptab" style="width:100%;"><b>Visual Results</b>
	</div>
	<form action="added_pat.php" method="post">
		...
		<div style="width:100%; height:100%; float:left;">
			...
			<div style="width:33%; height:100px; float:left;" class="p_right;">
				<b>Appliance check</b>
				<table style="width:100%">
					<tr>
						<td>Pass</td>
		...
		<div style="width:100%; height:100%; float:left;">
			...
			<!-- Fuse size end -->
			<!--Earth Check Start
									<div style="width:33%; height:100px; float:left;" class="p_right;"><!--Table div
										<b>Earth Check</b>
										<table style="width:100%">
											<tr>
												<td>Pass</td>
												<td><input title="" type="radio" name="earth_check" value="pass" required></input></td>
											</tr>
											<tr>
												<td>Fail</td>
												<td><input title="" type="radio" name="earth_check" value="fail"></input></td>
											</tr>
										</table>
									</div>
									<!-- Earth Check end -->
		...
		<div id="toptab" style="width:100%; height:100%"><b>Test Results</b></div>
		<div style="width:100%; height:100%; float:left;">
			...
			<!-- Earth Continuity Check start -->
			<div style="width:33%; height:100%; float:left;" class="p_right;">
				<!--Table div-->
				<b>Earth Continuity Check</b>
				<table style="width:100%">
					<tr>
						<td>Pass</td>
						<td>
							<input title="" type="radio" name="earth_check" value="pass" required></input>
						</td>
					</tr>
					<tr>
						<td>Fail</td>
						<td>
							<input title="" type="radio" name="earth_check" value="fail"></input>
						</td>
					</tr>
				</table>
			</div>
			<!-- Earth Continuity Check end -->

			<!--Rersistance reading optional textbox -->
			<div style="width:33%; height:100%; float:left;" class="p_right;">
				<!--Table div-->
				<b>Optional resistance reading</b>
				<input type="text" name="ohm_reading" id="ohm"; style="width:75%;"/>ohm
			</div>
			<!-- Resistance reading optional textbox -->
		</div>
		<!-- End of row -->
